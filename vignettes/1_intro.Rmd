...
(Other information, in particular descriptives such as means or SDs, can also be returned via this function – but this is described in a [separate vignette](https://gasparl.github.io/possa/vignettes/2_multiple_hypotheses.html).)
...
Go to the [next](https://gasparl.github.io/possa/vignettes/2_multiple_hypotheses.html) (and the only other important) `POSSA` vignette see how to record descriptives, easily check varying factors, and test multiple hypotheses.
